...
public class TolerantPPHolonomicDriveController implements PathFollowingController {
   ...
   */
  public TolerantPPHolonomicDriveController(
  ...
  public static void setRotationTargetOverride(
    ...
    TolerantPPHolonomicDriveController.rotationTargetOverride = rotationTargetOverride;
  }
  ...
  public static void overrideXFeedback(DoubleSupplier xFeedbackOverride) {
    TolerantPPHolonomicDriveController.xFeedbackOverride = xFeedbackOverride;
  }
  ...
  public static void clearXFeedbackOverride() {
    TolerantPPHolonomicDriveController.xFeedbackOverride = null;
  }
  ...
  public static void overrideYFeedback(DoubleSupplier yFeedbackOverride) {
    TolerantPPHolonomicDriveController.yFeedbackOverride = yFeedbackOverride;
  }
  ...
  public static void clearYFeedbackOverride() {
    TolerantPPHolonomicDriveController.yFeedbackOverride = null;
  }
  ...
  public static void overrideRotationFeedback(DoubleSupplier rotationFeedbackOverride) {
    TolerantPPHolonomicDriveController.rotFeedbackOverride = rotationFeedbackOverride;
  }
  ...
  public static void clearRotationFeedbackOverride() {
    TolerantPPHolonomicDriveController.rotFeedbackOverride = null;
  }
